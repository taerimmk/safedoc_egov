					...
					<div class="col-sm-9 col-md-9">
						<form:form commandName="board" name="board" method="post"
							...
							<input type="hidden" name="nttId"
								value="<c:out value='${searchVO.nttId}'/>" />
							<input type="hidden" name="parnts"
								value="<c:out value='${searchVO.parnts}'/>" />
							<input type="hidden" name="sortOrdr"
								value="<c:out value='${searchVO.sortOrdr}'/>" />
							<input type="hidden" name="replyLc"
								value="<c:out value='${searchVO.replyLc}'/>" />
								...
								<li>
									<div class="form-group has-feedback">
										<label>견적제목 <span class="required">*</span></label> <input
											...
											placeholder="견적제목" required="" maxlength="60"
											value="RE: <c:out value='${result.nttSj}'/>" /> <small
