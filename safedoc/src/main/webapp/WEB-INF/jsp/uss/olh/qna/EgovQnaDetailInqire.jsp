...
<body>
	...
	<div id="wrap">
		...
		<!-- //header end -->
		<!--  타이틀 이미지 시작 -->
		<div id="title_img_div">
			<img src="<c:url value='/'/>images/title_image/img_title04.gif"
				alt="" />
		</div>
		<!--  //타이틀 이미지 끝 -->
		<div id="bodywrap">
					...
					<form name="QnaManageForm"
							...
							<div class="search_top_table">
								<table summary="Q&amp;A에 대한 정보를 조회합니다.">
									...
									<tr>
										...
										<td class="td_content"><c:out value="${result.wrterNm}" />
										</td>
									</tr>

									<tr>
										<td class="td_width">전화&nbsp;&nbsp;</td>
										<td class="td_content"><c:out value="${result.areaNo}" />-<c:out
									...
									<tr>
										...
										<td class="td_content"><c:out value="${result.qestnSj}" />
										</td>
									</tr>

									<tr>
										<td class="td_width"><label for="qestnCn">질문내용</label>&nbsp;&nbsp;</td>
										<td class="td_content"><textarea name="qestnCn" cols="95"
												rows="10" readonly title="질문내용"><c:out
													value="${result.qestnCn}" />
					      </textarea></td>
									</tr>
									...
									<c:if test="${result.qnaProcessSttusCode == '3'}">
										<tr>
											...
											<td class="td_content"><textarea name="answerCn"
													cols="95" rows="5" readonly="readonly" title="답변내용"><c:out
														value="${result.answerCn}" />
					      </textarea></td>
										</tr>
										<tr>
					  ...
					  <tr> 
					   ...
					   -->
						...
						<input name="writngPassword" type="hidden" value=""> <input
