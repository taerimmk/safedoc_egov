		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-6 col-md-10 col-lg-9 right-box">
					...
					<image src="/img/png-icons/search-icon.png" alt="" width="16"
			  ...
			  -->
					...
					<image src="/img/png-icons/phone-icon.png" alt="" width="16"
											height="16" style="vertical-align: top;">
				  </svg>
								</a>
							</div>
						...
						<div class="primary">
							<div class="navbar navbar-default" role="navigation">
								<button type="button" class="navbar-toggle btn-navbar collapsed"
									...
									<span class="text">Menu</span> <span class="icon-bar"></span> <span
										class="icon-bar"></span> <span class="icon-bar"></span>
								</button>

								<nav class="collapse collapsing navbar-collapse">
									<ul class="nav navbar-nav navbar-center">
										<li class="parent"><a href="#">회사소개</a>
											<ul class="sub">
												<li><a
													href="<c:url value="/EgovPageLink.do?link=intro/greeting"/>">인사말</a></li>
												<li><a
													href="<c:url value="/EgovPageLink.do?link=intro/comIntro"/>">회사소개</a></li>
												<li><a
													href="<c:url value="/EgovPageLink.do?link=intro/ceoIntro"/>">원장소개</a></li>
												<li><a
													href="<c:url value="/EgovPageLink.do?link=intro/organization"/>">조직도</a></li>
												<li><a
													href="<c:url value="/EgovPageLink.do?link=intro/location"/>">오시는길</a></li>
											</ul></li>
				...
				<!-- <div class="search-active col-sm-9 col-md-9">
					...
					<form name="search-form">
						<input class="search-string form-control" type="search"
							placeholder="Search here" name="search-string">
